...
public class MenuItemDaoCollectionImplTest {
	...
	{
		MenuItemDaoCollectionImpl menuItemDaoCollectionImpl=new MenuItemDaoCollectionImpl();
		System.out.println("Menu Item List:"+menuItemDaoCollectionImpl.getMenuItemListCustomer());
	...
	{
		MenuItem menuItem=new MenuItem(2,"Cake",129.00f,true,DateUtil.convertToDate("11/12/2019"),"Main course",false);
		...
		System.out.println("Modification details are: "+menuItenDao.getMenuItem((long)2));
